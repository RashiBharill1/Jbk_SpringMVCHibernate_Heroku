...
public class AdminController {
	...
	public String dashboard(@RequestParam("id") int theId, Model theModel, HttpServletRequest request) {
		...
		request.setAttribute("sid", theAdmin.getSid());
	    ...
	    void loadStates(Model theModel) throws IllegalStateException {

	        //Specify the returning object you want here
		 	theModel.addAttribute("stateList", adminService.loadState());
