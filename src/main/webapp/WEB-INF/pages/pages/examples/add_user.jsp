									...
									<div class="form-group">
										...
										<div class="col-sm-4" style="margin-top: 6px;">
											...
											<input name="isDefault" required id="" value="Y"
												type="radio" style="margin-right: 2px;">
											Yes <input name="isDefault" required id="" value="N"
												type="radio" style="margin-right: 2px; margin-left: 10px;">
											No
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<%-- <select required class="form-control" name="state"
											 ...
											 <select required class="form-control" name="sid" value="<%=sid%>">
												<option value="">Select State</option> 
												
													<c:forEach items="${stateList}" var="stateAdmin">
													
													<option value='<c:out value ="${stateAdmin.getSid()}"/>'><c:out value="${stateAdmin.getState()}"/></option>
													</c:forEach>
												</select>	
